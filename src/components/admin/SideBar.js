import { faCartShopping, faHourglassEmpty, faHouse, faMobile, faUser } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <Col md={2} className='side-bar'>
            ...
            <ul className='adminsidebar' style={{ marginTop: "50px" }}>
                ...
                <li><NavLink to="/adminusers"><div className='navlink-container'>
                    <div className='icon-container'>
                        <FontAwesomeIcon icon={faUser} />
                    </div>
                    <p style={{ marginLeft: "30px" }}>Users</p>
                </div></NavLink></li>
                <li><NavLink to="/adminorders"><div className='navlink-container'>
                    <div className='icon-container'>
